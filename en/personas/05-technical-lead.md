...
tags: ["persona", "technical-lead", "workshop", "en"]
---

# Persona — Technical Lead

> **Pair 3 · Implementation · SDLC phases: Implementation + Evolution.** You and the Developer are co-responsible for shipping working code by 17:00.
...
You support Stages 1 and 2 with complexity calibration. You lead Stage 3 and co-lead Stage 4.

## Handoffs

| | Who | Artifact |
|---|---|---|
| **Receives from** | Pair 2 at H2 | `SPECIFICATION.md` + ADRs + scope |
| **Hands off to** | Pair 5 at H3 | Working prototype + green CI |
| **Stays on-call for** | All pairs | Unblocking |
...
- **Your role**: Ensure translation quality and coordinate parallel implementation
...
- [`copilot-3-modes.md`](../cheat-sheets/copilot-3-modes.md) especially — you switch between all three constantly.
...
| Previous | Home | Next |
|----------|------|------|
| [04 Software Architect](04-software-architect.md) | [Personas](README.md) | [06 Developer](06-developer.md) |

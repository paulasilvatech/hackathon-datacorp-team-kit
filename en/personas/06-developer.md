...
version: "2.0.0"
persona_id: "06"
pair: "3 · Implementation"
sdlc_phase: "Implementation + Evolution"
tags: ["persona", "developer", "workshop", "en"]
---

# Persona — Developer

> **Pair 3 · Implementation · SDLC phases: Implementation + Evolution.** You and the Technical Lead are co-responsible. You're the one with hands on the keyboard the most.
...
You contribute to Stage 1 by reading legacy with Copilot Chat. You comment feasibility in Stage 2. You lead the keyboard in Stages 3 and 4.

## Handoffs

| | Who | Artifact |
|---|---|---|
| **Receives from** | Pair 2 at H2 | REQ-IDs + bounded contexts + ADRs |
| **Hands off to** | Pair 4 (concurrent) for tests; Pair 5 at H3 for ops | PRs with tests |
| **Stays on-call for** | All pairs at S4 | Agent PR review |
...
- **Your role**: Implement the Natural → Java translation guided by the EARS spec
...
- [`copilot-3-modes.md`](../cheat-sheets/copilot-3-modes.md) — this is your map for the day.
- [`specky-workflow.md`](../cheat-sheets/specky-workflow.md) — phases 5 to 10.
- [`model-routing.md`](../cheat-sheets/model-routing.md) — Haiku 4.5 for simple snippets, Sonnet 4.6 as the default, Opus 4.6 for design.
...
| Previous | Home | Next |
|----------|------|------|
| [05 Technical Lead](05-technical-lead.md) | [Personas](README.md) | [07 DBA](07-dba.md) |

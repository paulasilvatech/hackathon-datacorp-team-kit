...
| De                                              | Para                                        | Status                        |
| ----------------------------------------------- | ------------------------------------------- | ----------------------------- |
| `agent-kits/README.md` → agents                 | `.github/agents/*.agent.md`                 | ✅ Todos os 4 resolvem        |
| `agent-kits/*/README.md` → agents               | `.github/agents/*.agent.md`                 | ✅ Todos os 4 resolvem        |
...
| `agent-kits/README.md` (mesma tabela)                     | ✅ Corresponde              |
| `agent-kits/*/README.md` "Who Uses" (recortes por agente) | ✅ Todos os 4 correspondem  |
| `persona-kits/*/PERSONA.md` "Agents I Use" (recortes por persona) | ✅ Todos os 10 correspondem |

...
```
Travou? → regra dos 20 minutos (TEAM-FLOW.md §6)
...
Cheat-sheet do Copilot Chat? → cheat-sheets/copilot-3-modes.md
Modelo certo (Haiku/Sonnet)? → cheat-sheets/model-routing.md
```

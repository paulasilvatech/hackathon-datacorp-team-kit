...
locale: "pt-br"
canonical_path: "pt-br/persona-kits/04-software-architect/PERSONA.md"
...
- [`../cheat-sheets/spec-kit-workflow.md`](../../cheat-sheets/spec-kit-workflow.md) — `/speckit.plan`, `/speckit.tasks` e `/speckit.analyze`.

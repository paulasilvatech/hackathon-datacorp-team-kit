...
locale: "pt-br"
canonical_path: "pt-br/persona-kits/02-requirements-engineer/PERSONA.md"
...
- [`../cheat-sheets/spec-kit-workflow.md`](../../cheat-sheets/spec-kit-workflow.md) — `/speckit.specify` e `/speckit.clarify` com exemplos EARS.

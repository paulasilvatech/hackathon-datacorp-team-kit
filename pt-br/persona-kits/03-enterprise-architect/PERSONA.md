...
locale: "pt-br"
canonical_path: "pt-br/persona-kits/03-enterprise-architect/PERSONA.md"
...
- [`../cheat-sheets/spec-kit-workflow.md`](../../cheat-sheets/spec-kit-workflow.md) — especialmente `/speckit.plan` e `/speckit.analyze`.

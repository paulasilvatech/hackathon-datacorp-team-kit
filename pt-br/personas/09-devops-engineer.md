...
version: "1.0.0"
persona_id: "09"
tags: ["persona", "devops-engineer", "workshop", "terraform", "github-actions", "pt-br"]
---
...
1. **(Chat)** *"Crie um workflow GitHub Actions .github/workflows/ci.yml que: rode em push, configure Java 21 com cache do Maven, rode testes e construa uma imagem Docker."*
2. **(Edits)** *"Otimize o Dockerfile do backend: adicione cache de dependências do Maven, reduza a imagem final com Alpine e adicione health check."*
3. **(Chat)** *"`docker compose up` demora 3 minutos para subir. Analise os Dockerfiles e o docker-compose.yml e proponha 3 otimizações."*

...
- **Specky** no Estágio 2: a fase de Visão e Requirements é o terreno natural do PO.
- **Cowork** se precisar escrever briefings executivos ou notas de decisão.
- **Templates** do `25-personas-primitives` — prompts prontos para escrever stories, cortes de escopo e comunicação de risco.

## Cheat-sheets que você usa

- [`../cheat-sheets/copilot-3-modes.md`](../cheat-sheets/copilot-3-modes.md) — para saber quando é Chat (maior parte do seu dia), quando é Edits (raro), quando é Agent (Estágio 4).
- [`../cheat-sheets/specky-workflow.md`](../cheat-sheets/specky-workflow.md) — especialmente fases 1 (Visão) e 2 (Requirements).
...
1. **(Chat)** *"Analise o programa CALCBENF.NSN do SIFAP legado e liste as 5 regras de negócio com maior impacto no beneficiário. Para cada uma, diga se deve ser migrada, descartada ou evoluída."*
...
3. **(Chat)** *"O time quer implementar 8 features em 3 horas. Com base em complexidade, ajude-me a cortar para as 3 mais críticas para o ciclo mensal de pagamento."*

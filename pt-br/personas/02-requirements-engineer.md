---
title: "Card de Persona — Requirements Engineer"
description: "O que o Requirements Engineer faz dentro do time de 10 durante o Dia 2 do Legacy Modernization Workshop."
locale: "pt-br"
...
version: "1.0.0"
persona_id: "02"
tags: ["persona", "requirements-engineer", "workshop", "ears", "pt-br"]
---
...
- **Specky** — fase 2 (Requirements) é seu território. O plugin gera o esqueleto EARS para você refinar.
...
- Templates do `25-personas-primitives` — skills para extração de regras e conversão para EARS.

## Cheat-sheets que você usa

- [`../cheat-sheets/specky-workflow.md`](../cheat-sheets/specky-workflow.md) — fase 2 com exemplos EARS.
- [`../cheat-sheets/model-routing.md`](../cheat-sheets/model-routing.md) — para decidir quando usar Claude Sonnet 4.6 em vez de Opus 4.6 (requisitos pedem os dois).
...
3. **(Edits)** *"No SPECIFICATION.md, adicione requisitos EARS para o módulo de auditoria com base nas regras BR-008 a BR-012 do catálogo. Use os padrões Event e Unwanted Behavior."*
...
- **Specky não funciona?** Escreva EARS manualmente em SPECIFICATION.md — o formato é texto puro.
